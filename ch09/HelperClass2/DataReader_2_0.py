...
from ch09.HelperClass2.EnumDef import *
...
class DataReader_2_0(object):
    ...
    def __normalizeY(self, raw):
        ...
        YNew = (raw - self.YNorm[0, 0]) / self.YNorm[0, 1]
        return YNew
    ...
    def __ToZeroOne(self, Y, positive_label=1, negative_label=0, positive_value=1, negative_value=0):
        ...
        for i in range(self.num_train):
            ...
            if Y[i, 1] == positive_label:
                YNew[i, 1] = positive_value
    ...
    def DenormalizeY(self, predicate_data):
        real_value = predicate_data * self.YNorm[0, 1] + self.YNorm[0, 0]
        return real_value
    ...
    def NormalizePredicateData(self, XPredicate):
        ...
        for i in range(self.num_train):
            x = XPredicate[i, :]
            XNew[i, :] = (x - self.XNorm[i, 0]) / self.XNorm[i, 1]
        return XNew
